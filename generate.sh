...
echo "|    by @hourlier96       |"
echo -e "===========================\n"
echo "This script will generate a new folder at $(realpath ../) with your new FastAPI project based on the template."
echo -e "Ensure the project slug you gonna choose is available at this location'\n"
